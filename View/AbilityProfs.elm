...
viewProf model ability =
    let
        ...
        prof =
            Model.Abilities.value abilityProfs ability
        ...
        mod =
            Model.Abilities.modifier abilities ability + profBonus
    in
        div [ style profStyle ]
            [ input
                [ type_ "checkbox"
                , checked prof
                , onClick (ToggleAbilityProf ability)
                ]
                []
